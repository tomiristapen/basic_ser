...
type OrderItem struct {
	...
	Price         float64                `protobuf:"fixed64,3,opt,name=price,proto3" json:"price,omitempty"` // <-- Добавлено поле цены
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OrderResponse) GetProducts() []*OrderItem {
	if x != nil {
		return x.Products
	}
	return nil
...
const file_proto_order_proto_rawDesc = "" +
	...
	"\bproducts\x18\x03 \x03(\v2\x10.order.OrderItemR\bproducts\"\\\n" +
	"\tOrderItem\x12\x1d\n" +
	"\n" +
	...
	"\bproducts\x18\x03 \x03(\v2\x10.order.OrderItemR\bproducts\x12\x16\n" +
...
var file_proto_order_proto_depIdxs = []int32{
	...
	1, // 1: order.OrderResponse.products:type_name -> order.OrderItem
