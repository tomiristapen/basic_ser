...
type CreateProductRequest struct {
	...
	Price         float64                `protobuf:"fixed64,4,opt,name=price,proto3" json:"price,omitempty"` // ← ИЗМЕНЕНО: было float
...
type ProductResponse struct {
	...
	Price         float64                `protobuf:"fixed64,5,opt,name=price,proto3" json:"price,omitempty"` // ← ИЗМЕНЕНО: было float
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\fListProducts\x12\x1e.inventory.ListProductsRequest\x1a\x1f.inventory.ListProductsResponseB#Z!inventory-service/proto;inventoryb\x06proto3"
...
var file_proto_inventory_proto_depIdxs = []int32{
	...
	1, // 7: inventory.InventoryService.GetProductByID:output_type -> inventory.ProductResponse
